...
public class BookStoreProject2 {
	...
	public static void main(String[] args) 
		{
			...
			String book3 = "Owls Do Not Have to Man Death, Chip Livingston";
			...
			System.out.println("Purchase" + " " + numBook1 + " " + "copies of" + " " + book1 + "." + "Each copy cost $" + threeSisters + ".");
			System.out.println("Purchase" + " " + numBook2 + " " + "copies of" + " " + book2 + "." + "Each copy cost $" + songSolomon + ".");
			System.out.println("Purchase" + " " + numBook3 + " " + "copy of" + " " + book3 + "." + "Each copy cost $" + String.format("%.2f", owlsDeath) + "."); 
